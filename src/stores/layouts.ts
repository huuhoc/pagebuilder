...
export const useElementStore = defineStore('element', () => {
  ...
  const availableElements = ref<ListItemsElementType[]>([
    ...
    },
    {
      ...
      el: 'ElSliderHome',
      name: 'Slider Home',
      description: 'Hiển thị slider trang chủ',
      content: {
        title: {
          type: 'InputText',
          label: 'Tiêu đề',
    ...
    },
    {
      ...
      el: 'ElIntroHome',
      name: 'Intro Home',
      description: 'Hiển thị thông tin giới thiệu ở trang chủ',
      content: {
        title: {
          type: 'InputText',
          label: 'Tiêu đề',
    ...
    },
    {
      ...
      el: 'ElBoxDongGop',
      name: 'Box Đóng góp',
      description: 'Hiển thị box tài trợ, đóng góp trang chủ',
      content: {
        title: {
          type: 'InputText',
          label: 'Tiêu đề',
        ...
        textLeft: {
          type: 'CheckBox',
          label: 'Vị trí nội dung bên trái',
        },
      },
      styles: {
        column: {
    ...
    },
    {
      ...
      el: 'ElBoxDonate',
      name: 'Box Donate',
      description: 'Hiển thị box quyên tặng',
      content: {
        title: {
          type: 'InputText',
          label: 'Tiêu đề',
    ...
    },
    {
      ...
      el: 'ElBoxTitle',
      name: 'Box Title',
      description: 'Hiển thị tiêu đề, nội dung',
      content: {
        title: {
          type: 'InputText',
          label: 'Tiêu đề',
    ...
    },
    {
      id: uuidv6(),
      el: 'ElBoxTitleAbout',
      name: 'Box Title About',
      description: 'Hiển thị số - tiêu đề cho trang giới thiệu',
      content: {
        title: {
          type: 'InputText',
          label: 'Tiêu đề',
          value: 'Box Title About',
        },
        numberPost: {
          type: 'InputNumber',
          label: 'Số tiêu đề',
    ...
    },
    {
      id: uuidv6(),
      el: 'ElBoxAbout',
      name: 'Box Description About',
      description: 'Hiển thị box thông tin giới thiệu',
      content: {
        title: {
          type: 'InputText',
          label: 'Tiêu đề',
          value: 'Box Description About',
        },
        description: {
          type: 'EditorText',
          label: 'Nội dung',
    ...
    {
      id: uuidv6(),
      el: 'ElBoxDescriptionDonate',
      name: 'Box Description Tài trợ, đóng góp',
      description: 'Hiển thị box thông tin Tài trợ, đóng góp',
      content: {
        title: {
          type: 'InputText',
          label: 'Tiêu đề',
    ...
    },
    {
      ...
      description: 'Hiển thị thông tin người quyên tặng trang chủ',
      content: {
        title: {
          type: 'InputText',
          label: 'Tiêu đề',
    ...
    },
    {
      ...
      description: 'Box nhiều nội dung',
      content: {
        title: {
          type: 'InputText',
          label: 'Tiêu đề',
